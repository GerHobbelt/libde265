...
slice_unit::slice_unit(decoder_context_layer* decctx)
  : ctx(decctx),
    nal(NULL),
    shdr(NULL),
...
decoder_context_layer::decoder_context_layer()
{
  //memset(ctx, 0, sizeof(decoder_context_layer));
...
void decoder_context_layer::set_image_allocation_functions(de265_image_allocation* allocfunc,
                                                     void* userdata)
{
  if (allocfunc) {
...
de265_error decoder_context_layer::start_thread_pool(int nThreads)
{
...
void decoder_context_layer::stop_thread_pool()
{
...
void decoder_context_layer::reset()
{
...
void decoder_context_layer::init_thread_context(thread_context* tctx)
{
...
void decoder_context_layer::add_task_decode_CTB_row(thread_context* tctx,
...
void decoder_context_layer::add_task_decode_slice_segment(thread_context* tctx, bool firstSliceSubstream,
                                                    int ctbx,int ctby)
{
...
de265_error decoder_context_layer::read_vps_NAL(bitreader& reader)
{
...
de265_error decoder_context_layer::read_sps_NAL(bitreader& reader)
{
...
de265_error decoder_context_layer::read_pps_NAL(bitreader& reader)
{
...
de265_error decoder_context_layer::read_sei_NAL(bitreader& reader, bool suffix)
{
...
de265_error decoder_context_layer::read_eos_NAL(bitreader& reader)
{
  FirstAfterEndOfSequenceNAL = true;
  return DE265_OK;
}

de265_error decoder_context_layer::read_slice_NAL(bitreader& reader, NAL_unit* nal, nal_header& nal_hdr)
{
...
de265_error decoder_context_layer::decode_some(bool* did_work)
{
  de265_error err = DE265_OK;
...
de265_error decoder_context_layer::decode_slice_unit_sequential(image_unit* imgunit,
...
void decoder_context_layer::mark_whole_slice_as_processed(image_unit* imgunit,
                                                    slice_unit* sliceunit,
                                                    int progress)
{
...
de265_error decoder_context_layer::decode_slice_unit_parallel(image_unit* imgunit,
                                                        slice_unit* sliceunit)
{
  de265_error err = DE265_OK;
...
de265_error decoder_context_layer::decode_slice_unit_WPP(image_unit* imgunit,
                                                   slice_unit* sliceunit)
{
  de265_error err = DE265_OK;
...
de265_error decoder_context_layer::decode_slice_unit_tiles(image_unit* imgunit,
                                                     slice_unit* sliceunit)
{
  de265_error err = DE265_OK;
...
de265_error decoder_context_layer::decode_NAL(NAL_unit* nal)
{
  //return decode_NAL_OLD(nal);

  decoder_context_layer* ctx = this;
...
de265_error decoder_context_layer::decode(int* more)
{
  decoder_context_layer* ctx = this;
...
void decoder_context_layer::process_nal_hdr(nal_header* nal)
{
...
void decoder_context_layer::process_vps(video_parameter_set* vps)
{
  this->vps[ vps->video_parameter_set_id ] = *vps;
}


void decoder_context_layer::process_sps(seq_parameter_set* sps)
{
  //push_current_picture_to_output_queue();
...
void decoder_context_layer::process_pps(pic_parameter_set* pps)
{
  //push_current_picture_to_output_queue();
...
/* 8.3.1
 */
void decoder_context_layer::process_picture_order_count(decoder_context_layer* ctx, slice_segment_header* hdr)
{
 ...
 */
int decoder_context_layer::generate_unavailable_reference_picture(decoder_context_layer* ctx,
 ...
 */
void decoder_context_layer::process_reference_picture_set(decoder_context_layer* ctx, slice_segment_header* hdr)
{
 ...
 */
bool decoder_context_layer::construct_reference_picture_lists(decoder_context_layer* ctx, slice_segment_header* hdr)
{
...
void decoder_context_layer::run_postprocessing_filters_sequential(de265_image* img)
{
#if SAVE_INTERMEDIATE_IMAGES
    char buf[1000];
...
void decoder_context_layer::run_postprocessing_filters_parallel(image_unit* imgunit)
{
  de265_image* img = imgunit->img;
...
/*
void decoder_context_layer::push_current_picture_to_output_queue()
{
  push_picture_to_output_queue(img);
}
*/

de265_error decoder_context_layer::push_picture_to_output_queue(image_unit* imgunit)
{
...
bool decoder_context_layer::process_slice_segment_header(decoder_context_layer* ctx, slice_segment_header* hdr,
...
void decoder_context_layer::remove_images_from_dpb(const std::vector<int>& removeImageList)
{
...
int  decoder_context_layer::get_highest_TID() const
{
...
void decoder_context_layer::set_limit_TID(int max_tid)
{
  limit_HighestTid = max_tid;
  calc_tid_and_framerate_ratio();
}

int decoder_context_layer::change_framerate(int more)
{
...
void decoder_context_layer::set_framerate_ratio(int percent)
{
  framerate_ratio = percent;
  calc_tid_and_framerate_ratio();
}

void decoder_context_layer::compute_framedrop_table()
{
  int highestTID = get_highest_TID();
...
void decoder_context_layer::calc_tid_and_framerate_ratio()
{
  int highestTID = get_highest_TID();
